...
export default function Menu() {
    return (
        <div className='menu'>
            ...
            <ul>
                <li><Link activeClassName="currentPage">Services</Link></li>
                <li><Link activeClassName="currentPage">Contact</Link></li>
                <li><Link activeClassName="currentPage">Team</Link></li>
